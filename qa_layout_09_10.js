...
let failed=false;
for(let slide=81;slide<=100;slide++){
 const url=`${harness}?target=${encodeURIComponent('prototype_09_10_v2.html')}&slide=${slide}`;
 ...
 if(obj.outsideCount||slideOverflow||deckOverflow){failed=true;fs.writeFileSync(`qa_09_10_layout_slide${slide}.json`,JSON.stringify(obj,null,2));}
}
